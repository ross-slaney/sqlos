...
/// </summary>
public interface ISqlOSFgaSubjectService
{
    /// <summary>
    /// Create a new subject.
    /// </summary>
    Task<SqlOSFgaSubject> CreateSubjectAsync(
        string displayName,
    ...
    /// </summary>
    Task<SqlOSFgaUser> CreateUserAsync(
        string displayName,
        string? email = null,
        bool isActive = true,
        string? organizationId = null,
    ...
    /// </summary>
    Task<SqlOSFgaAgent> CreateAgentAsync(
        string displayName,
    ...
    /// </summary>
    Task<SqlOSFgaServiceAccount> CreateServiceAccountAsync(
        string displayName,
        string clientId,
    ...
    /// </summary>
    Task<SqlOSFgaUserGroup> CreateGroupAsync(
        string name,
        string? description = null,
    ...
    /// </summary>
    Task<List<SqlOSFgaUserGroup>> GetGroupsForSubjectAsync(string subjectId, CancellationToken cancellationToken = default);
}
