...
var api = builder.AddProject<Projects.SqlOS_Example_Api>("api")
    ...
    .WithEnvironment("ExampleFrontend__Origin", "http://localhost:3001")
    .WithEnvironment("ExampleFrontend__CallbackUrl", "http://localhost:3001/auth/callback")
...
builder.AddNpmApp("web", "../SqlOS.Example.Web", "dev")
    ...
    .WithEnvironment("NEXTAUTH_URL", "http://localhost:3001")
