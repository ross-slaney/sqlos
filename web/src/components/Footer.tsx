...
export default function Footer() {
  return (
    <footer className="border-t border-stone-200/80">
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-4 px-6 py-6 sm:flex-row sm:justify-between sm:gap-0">
        <Link href="/" className="text-[14px] font-semibold text-stone-950">
          SqlOS
        </Link>
        <div className="flex flex-wrap items-center justify-center gap-5 text-[13px] text-stone-400">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 transition-colors hover:text-stone-600"
          >
