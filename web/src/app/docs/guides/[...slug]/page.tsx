  ...
  return (
    <div className="flex min-h-[calc(100vh-65px)]">
      ...
      <div className="flex flex-1 justify-center">
        <article className="w-full max-w-3xl px-8 py-10 lg:px-12">
