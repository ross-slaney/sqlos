...
SqlOS owns its own database schema. On startup, `UseSqlOSAsync()` runs embedded SQL scripts to create or update tables. Your app's EF Core migrations do not manage SqlOS tables.
