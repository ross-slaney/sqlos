...
- [Email OTP](/docs/authserver/email-otp) for passwordless sign in/sign up.
- [Email Invitations](/docs/authserver/invitations) for organization onboarding.
- [Email Branding](/docs/authserver/email-branding) for built-in auth email templates.
...
- [Todo Sample](/docs/authserver/todo-sample) -- hosted auth, simple FGA, and MCP-oriented flows
- [FGA Overview](/docs/fga/overview) -- hierarchical authorization and query filtering
- [SDK Reference](/docs/reference/sdk-reference) -- all services and methods
