...
## Run the Todo sample first

If your first goal is OAuth and public-client onboarding, start with the narrow Todo sample:
...
- [Todo Sample](/docs/guides/authserver/todo-sample) -- hosted-first OAuth and MCP-oriented flows
