...
Resources form a tree. Grants on a parent apply below it. [Resource hierarchy](/docs/fga/resource-hierarchy).
...
See [Permissions](/docs/fga/permissions).
