...
For single-resource access, use [AuthorizedDetailAsync](/docs/guides/fga/detail-endpoint). For mutations, use [CheckAccessAsync](/docs/guides/fga/checking-a-permission).
