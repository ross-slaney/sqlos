...
All subject types use the same FGA authorization -- the same `CheckAccessAsync` and `BuildFilterAsync` calls work regardless of whether the subject is a user, agent, service account, or group.
