...
<Callout type="info" title="Version contract">
  These docs target **SqlOS 4.2.0**, **.NET 9**, **EF Core 9**, and **SQL Server**. Use the same package version as the docs; older releases do not include the complete current schema and source/reference contract.
</Callout>
