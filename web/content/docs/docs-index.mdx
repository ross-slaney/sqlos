...
<Callout type="info" title="Version contract">
  These docs target **SqlOS 3.25.0**, **.NET 9**, **EF Core 9**, and **SQL Server**. Use the same package version as the docs; older releases do not include the complete current schema and source/reference contract.
</Callout>
...
<CardGrid cols={2}>
  ...
  <Card title="Sign in from ASP.NET Core" description="Use the built-in OAuth handler, PKCE, and a secure application cookie." href="/docs/quickstarts/aspnet-core-login" />
