...
This quickstart uses the source at **SqlOS 4.1.0**. Local password authentication is the default, so the first run does not require Azure Communication Services, Twilio, or an OIDC provider.
