...
>
  Install SqlOS 4.2.0, register one SQL Server or PostgreSQL `DbContext`, declare one application, and map the routes. FGA modeling and advanced client registration can wait.
</Banner>
