...
When you set a primary domain, AuthServer uses it for [home realm discovery](/docs/authserver/home-realm-discovery). Users with matching email domains are automatically routed to SSO instead of password login.
