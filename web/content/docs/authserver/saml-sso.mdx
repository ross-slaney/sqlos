...
1. The client generates a high-entropy PKCE verifier, its S256 challenge, and a state value.
...
4. AuthServer binds the client, exact redirect URI, state, and S256 challenge to the SAML authorization request, then redirects to the IdP.
