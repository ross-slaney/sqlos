...
`BuildUiUrl` present means headless; there is no second switch. Continue with [Build your own login and signup UI](/docs/guides/custom-login-ui) and the [headless reference](/docs/guides/custom-login-ui).
