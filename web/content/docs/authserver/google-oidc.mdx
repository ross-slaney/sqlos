...
<Banner
  ...
  href="/docs/authserver/oidc-auth"
...
4. Confirm the connection is enabled. Newly created API/dashboard connections are enabled by default; the toggle is useful after an operator disables one.
