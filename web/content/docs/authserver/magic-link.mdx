...
SqlOS creates the built-in `auth.magic-link` transactional template automatically. It uses [Email Branding](/docs/guides/auth-branding), and rendered bodies are suppressed in delivery history because they contain token-bearing links.
