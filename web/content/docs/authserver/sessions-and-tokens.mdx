...
Private signing material is never returned by this endpoint or stored as plaintext in the application database. Configure the separate custody boundary before startup; see [Signing-Key Custody](/docs/authserver/signing-key-custody).
