...
If you are still deciding whether headless mode is the right fit, start with [Headless Auth](/docs/guides/authserver/headless-auth) and [Hosted vs Headless Auth](/docs/guides/authserver/hosted-vs-headless).
...
If you want the product framing, go back to [Headless Auth](/docs/guides/authserver/headless-auth) and [Headless Auth Server Mode: Keep OAuth, Own the UI](/blog/headless-auth-server-mode).
