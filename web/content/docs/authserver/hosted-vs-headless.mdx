...
Headless uses one switch: `BuildUiUrl`. If that callback exists, `/sqlos/auth/authorize` redirects into your app. [Build the custom UI](/docs/guides/custom-login-ui) or review the [mode details](/docs/guides/custom-login-ui#how-sqlos-picks-the-ui).
...
How-to: [Custom login UI](/docs/guides/custom-login-ui) · [Headless Auth reference](/docs/guides/custom-login-ui) · [Phone OTP](/docs/authserver/phone-otp) · [Email Invitations](/docs/guides/invite-only-b2b-onboarding) · [CLI OAuth](/docs/guides/terminal-auth)
