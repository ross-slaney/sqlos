...
- Password, email OTP, phone OTP, OIDC, and SAML support
...
- Email OTP, phone OTP, invitations, CLI device approval, OIDC, and SAML still handled by SqlOS
...
How-to: [Headless Auth](/docs/authserver/headless-auth) · [Phone OTP](/docs/authserver/phone-otp) · [Email Invitations](/docs/authserver/invitations) · [CLI OAuth](/docs/authserver/cli-oauth)
