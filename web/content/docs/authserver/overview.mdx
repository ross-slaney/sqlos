...
<Callout type="info" title="Recommended reading order">
  ...
  2. [Password login](/docs/authserver/password-login), [Email OTP](/docs/authserver/email-otp), or [Magic Link](/docs/authserver/magic-link) → [OIDC](/docs/authserver/oidc-auth) / [SAML](/docs/authserver/saml-sso)
...
<CardGrid cols={3}>
  ...
  <Card title="Users" description="Email/password, email OTP, magic-link, SSO-provisioned, or OIDC-linked identities." />
...
2. User enters email. [Home realm discovery](/docs/authserver/home-realm-discovery) picks password, Email OTP, magic link, or SSO.
3. User signs in (password, Email OTP, magic link, OIDC, or SAML).
...
| Service | Purpose |
| --- | --- |
| `SqlOSAuthService` | Login, Email OTP, magic links, invitations, refresh, logout, token validation |
...
[Headless Auth](/docs/authserver/headless-auth) · [Email OTP](/docs/authserver/email-otp) · [Magic Link](/docs/authserver/magic-link) · [MFA and TOTP](/docs/authserver/mfa-totp) · [Email Invitations](/docs/authserver/invitations) · [CLI OAuth](/docs/authserver/cli-oauth) · [Hosted vs Headless](/docs/authserver/hosted-vs-headless)
