...
2. User enters email. [Home realm discovery](/docs/authserver/password-login) picks password vs SSO.
...
[Headless Auth](/docs/authserver/headless-auth) · [Hosted vs Headless](/docs/authserver/hosted-vs-headless)
