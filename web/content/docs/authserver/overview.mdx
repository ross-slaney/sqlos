...
<Callout type="info" title="Recommended reading order">
  ...
  3. Advanced: [Clients](/docs/authserver/clients), [CIMD](/docs/authserver/client-id-metadata-documents), [DCR](/docs/authserver/dynamic-client-registration) — only when you need them
</Callout>
