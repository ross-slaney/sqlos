...
<Callout type="info" title="Recommended reading order">
  ...
  2. [Password login](/docs/authserver/password-login), [Email OTP](/docs/authserver/email-otp), [Magic Link](/docs/authserver/magic-link), or [Phone OTP](/docs/authserver/phone-otp) → [OIDC](/docs/authserver/oidc-auth) / [SAML](/docs/authserver/saml-sso) / [SCIM](/docs/authserver/scim-directory-sync)
  ...
  5. Advanced: [Clients](/docs/authserver/clients), [OpenID Provider](/docs/authserver/openid-provider), [Machine Clients](/docs/authserver/machine-clients), [Application Access](/docs/authserver/application-access), [CIMD](/docs/authserver/client-id-metadata-documents), [DCR](/docs/authserver/dynamic-client-registration) -- only when you need them
</Callout>
