...
<Callout type="info" title="Recommended reading order">
  ...
  5. Advanced: [Clients](/docs/authserver/clients), [Machine Clients](/docs/authserver/machine-clients), [Application Access](/docs/authserver/application-access), [CIMD](/docs/authserver/client-id-metadata-documents), [DCR](/docs/authserver/dynamic-client-registration) -- only when you need them
</Callout>
