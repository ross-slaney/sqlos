...
If your app uses organization onboarding, create an [Email Invitation](/docs/guides/invite-only-b2b-onboarding) instead of creating a user directly. The invitation acceptance flow verifies the invited email and creates or reactivates the membership transactionally.
