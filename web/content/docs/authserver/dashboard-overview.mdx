...
| Machine clients | `/sqlos/admin/auth/machine-clients` | Create confidential `client_credentials` clients, copy the one-time secret, rotate, revoke, and optionally bind an FGA service account |
