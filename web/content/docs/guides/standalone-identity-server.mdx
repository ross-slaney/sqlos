...
See [Headless Auth](/docs/guides/custom-login-ui) and [Hosted vs Headless](/docs/authserver/hosted-vs-headless).
...
<CardGrid cols={2}>
  ...
  <Card title="Application access" description="Assign applications to organizations, users, groups, and roles." href="/docs/guides/multi-app-access" />
