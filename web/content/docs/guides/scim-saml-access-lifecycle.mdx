...
- when this was the person's last active membership, the user becomes inactive and their own [calendar connections](/docs/guides/calendar-integration#offboarding-and-revocation) are revoked with reason `scim_deprovisioned`; reactivation does not restore them
...
- [Set up SAML SSO](/docs/authserver/saml-sso)
- [SCIM protocol and lifecycle reference](/docs/guides/scim-directory-sync)
