...
`credentials: "include"` is required in the browser so the AuthPage session cookie is sent. See [Build your own login and signup UI](/docs/guides/custom-login-ui) for the full view loop.
