...
The Todo demo above was started with password as its primary credential plus seeded GitHub and Microsoft connections. Provider buttons appear only for enabled connections.
