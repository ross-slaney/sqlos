...
Declare `app.Api = "/api"` when your API accepts SqlOS-issued tokens. Mapped endpoints under that prefix are already validated and `HttpContext.User` is populated; your endpoint still resolves the application subject explicitly.
