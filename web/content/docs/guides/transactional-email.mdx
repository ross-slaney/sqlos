...
<Banner
  ...
  href="/docs/guides/transactional-email"
...
Use [Email Branding](/docs/guides/auth-branding) for shared product identity and colors. Existing `BuildMessage` callbacks and custom `ISqlOSAuthEmailSender` implementations remain the advanced escape hatch for auth-specific layouts or provider behavior.
...
- [Transactional Email reference](/docs/guides/transactional-email)
