...
>
  `AddSqlOS` installs the dashboard middleware and maps the protocol, authentication, audit, email, and optional calendar endpoints at startup. This page separates interoperable protocol routes from UI handlers and trusted operator surfaces.
</Banner>
