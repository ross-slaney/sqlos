...
description: "Per-method reference for the AuthServer SDK: login, signup, token management, SSO, OIDC, and administration."
order: 11
section: reference
---
...
Every public method in the AuthServer module, with parameters, return types, and code examples.

**Namespace**: `SqlOS.AuthServer.Services`, `SqlOS.AuthServer.Contracts`
