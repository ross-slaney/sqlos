...
validated as an absolute HTTP or HTTPS URL without user information, and link-generation failures
invalidate the token without changing the enumeration-safe public response.
