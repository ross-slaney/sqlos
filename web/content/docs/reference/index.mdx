---
title: "Reference"
description: "Source-aligned reference for SqlOS 3.28.0 hosting, authentication, authorization, and integration APIs."
order: 7
section: reference
---
...
<Banner
  eyebrow="Reference"
  title="SqlOS 3.28.0 application API"
