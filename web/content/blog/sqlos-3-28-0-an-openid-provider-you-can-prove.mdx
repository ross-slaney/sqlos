...
- **New capabilities are opt-in** — nothing requires you to inspect the scope claim or register downstream relying parties; existing deployments keep working as before.
