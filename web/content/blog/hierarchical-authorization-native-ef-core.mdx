...
Continue with the [EF authorization quickstart](/docs/quickstarts/ef-authorization), [resource hierarchy guide](/docs/fga/resource-hierarchy), and [EF query-filter guide](/docs/fga/list-filter).
