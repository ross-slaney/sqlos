...
| List filtering | Authorization checks and discovery plus app query logic | EF predicate with `BuildFilterAsync` |
...
var filter = await authService
    .BuildFilterAsync<Project>(subjectId, "PROJECT_VIEW");
