...
The [Clients reference](/docs/authserver/clients#confidential-server-side-clients) covers server-side web clients. For service-to-service tokens and optional SqlOS FGA grants, use [Background jobs with machine clients](/docs/guides/service-account-jobs).
