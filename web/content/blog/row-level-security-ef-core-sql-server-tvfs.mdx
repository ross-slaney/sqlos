...
await app.UseSqlOSAsync(); // Creates schema, registers TVF
```

The [getting started guide](/docs/guides/getting-started) walks through the full setup. The [SHRBAC paper](https://github.com/ross-slaney/sqlos/blob/main/paper/shrbac-compsac-2026.pdf) covers the formal model and benchmark methodology.
