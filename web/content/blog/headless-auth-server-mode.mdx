...
## The EasyCOI-shaped problem

EasyCOI had product-quality signup and login screens long before it had a proper standards-facing authorization server.

That is a very common shape:

- the product team builds good auth UX
- later the app needs real OAuth
- now there is tension between “keep the good UI” and “stop faking the protocol”

Headless mode resolves that tension much better than a custom bridge.
...
If you want the exact consumer-app lifecycle with real snippets from the SqlOS Example app and EasyCOI, read [Headless Auth How-To](/docs/guides/authserver/headless-auth-how-to).
